...
class Habit:
    ...
    def add_habit(self):
        ...
        db.connect_db()
        db.add_habit(self.name, self.description, self.frequency)
        print(f"Habit '{self.name}' added to the database.")
        db.connection.close()
    ...
    def __str__(self):
        return f"Habit(name={self.name}, description={self.description}, frequency={self.frequency})"